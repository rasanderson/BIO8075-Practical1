...
## Interactive website
I have created an interactive website to help people use RStudio for the first time, which you might find useful to read before attempting this practical. You can access via Canvas or [through this link](https://naturalandenvironmentalscience.shinyapps.io/RstudioInstall/#section-navigating-r-studio)
...
It can also be accessed via the Newcastle University [Windows Virtual Desktop service](https://services.ncl.ac.uk/itservice/core-services/software/wvd/#accesswvd). RStudio is an integrated development environment (IDE) that makes it easier to manage your data analyses.  It comes in several versions, and RStudio Desktop it is also freely available for personal use:
...
* $response$ this is what is conventionally is plotted on the vertical y-axis of a graph. It is what you expect to change as a result of some intervention. e.g. are the numbers of species of insects greater on organic vs conventional farms? Your response is the number of species of insects
* $explanatory$ This is your intervention. This might be an experimental "treatment" but in biodiversity and conservation studies you might be comparing sites with different management regimes for example. Your explanatory might be categorical (like farm management) or continuous (e.g. elevation)
